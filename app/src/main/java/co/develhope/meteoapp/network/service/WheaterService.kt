...
interface WheaterService {
    ...
    @GET("forecast?hourly=temperature_2m,rain,showers,relativehumidity_2m,cloudcover,snowfall,weathercode,apparent_temperature,windspeed_10m&current_weather=true&timezone=Europe%2FBerlin")
